            ...
            <td colspan="3">
              <div class="inputForm">
                ...
                <span class="inpDirect" v-if="categoryTrigger">
                  ...
                  <input type="text" placeholder="메시지 명">
                </span>
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="3">
              ...
              <div class="telAddBox" v-if="receipTrigger01">
                <div class="innerBox">
                  <span class="saveBox">010-1234-5678 <button>닫기</button></span>
                  <span class="saveBox">010-1234-5678 <button>닫기</button></span>
                  <span class="saveBox">010-1234-5678 <button>닫기</button></span>
                  <span class="saveBox">010-1234-5678 <button>닫기</button></span>
                  <span class="saveBox">010-1234-5678 <button>닫기</button></span>
              ...
              <div v-if="receipTrigger03">
                <div class="boardTop" id="fileBoardTop">
                  <div class="left-po">
                    <!-- 2021-09-02 파일 업로드 유형 select 추가 -->
                    ...
                    <span class="uploadFileSet">
                      <span class="uploadFile">
                        <input type="file" id="file" @change="fileUpload" placeholder="CSV 파일 업로드"><!-- 2021-09-02 placeholder 수정 -->
                        <span class="upload-name">
                          {{ fileName }}
                        </span>
                        <label for="file">불러오기</label>
                      </span>
                      <a href="#none;" class="btnS" download>샘플 다운</a>
                    </span>
                  </div>
                </div>
                <!-- 수신자 리스트 테이블 -->
