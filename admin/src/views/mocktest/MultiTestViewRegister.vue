<template lang="html">
  <div>
    <!-- page layout -->
    <div class="multiTestViewRegister"><!-- class 없어도 유지 -->
      <div class="subTit">
        <span class="right">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>박노송</td>
              <td></td>
              <td><strong class="fBlue" @click="MocktestApplicants()">65 </strong>/ 70 명<br/>(999,999,999원)</td>
              <td><strong class="fBlue" @click="MocktestApplicants()">42 </strong>/ 50 명<br/>(999,999,999원)</td>
            ...
            <tr class="gray">
              ...
              <td>영어</td>
              <td>차미아</td>
              <td><strong class="fRed">마감</strong></td>
              <td><strong class="fBlue" @click="MocktestApplicants()">70 </strong>/ 70 명<br/>(999,999,999원)</td>
              <td><strong class="fBlue" @click="MocktestApplicants()">50 </strong>/ 50 명<br/>(999,999,999원)</td>
              <td>- / - 명<br/>( - 원)</td>
              <td><strong class="fBlue">50 </strong>/ 50 명<br/>(999,999,999원)</td>
              <td><strong class="fBlue">30 </strong>/ 30 명<br/>(999,999,999원)</td>
              <td>- / - 명<br/>( - 원)</td>
              <td><strong class="fBlue">20 </strong>/ 20 명<br/>(999,999,999원)</td>
              <td><strong class="fBlue">20 </strong>/ 20 명<br/>(999,999,999원)</td>
              <td>- / - 명<br/>( - 원)</td>
            </tr>
            <tr>
        ...
        <table>
          ...
          <thead>
            <tr>
              ...
              <th scope="col">과목(1)</th>
              <th scope="col">선생님(1)</th>
          ...
          <tbody>
            ...
            <tr class="gray">
              ...
              <td>채점</td>
              <td>25,000<br/><span class="fRed">(25,000)</span></td>
...
export default {
  ...
  methods: {
    ...
    MocktestApplicants() {
      let routeData = this.$router.resolve({name: 'MocktestApplicants', query: {data: "someData"}});
      window.open('/mkup/windowPopup/mocktestApplicants', '_blank', `width=1500,height=20000`);
    },
  },
  components: {
  }
