<template lang="html">
	<div>
		<div class="pageTit">
			<h2>교재 등록/현황</h2>
			<span><router-link to="/mkup/lecture/singleCourse">강좌/교재</router-link><router-link to="/mkup/lecture/bookMgt">교재 관리</router-link><router-link to="/mkup/lecture/bookMgt">교재 등록/현황</router-link><em>신규등록</em></span>
		</div>
	  <div class="content">
	    <article>
	      <!-- page layout -->
	      <div class="bookMgtWrite">
					<!-- 교재 기본정보 -->
		      <div class="subTit cpRight">
						<h3>교재 기본정보</h3>
						<div class="grayBgBox">
              <span class="checkSet">
                <input type="checkbox" id="bookNew"/>
              ...
              <span class="checkSet">
                ...
                <label for="bookBest"><i></i>BEST</label>
						...
						<span class="right">
							<button class="btnM green" @click="toastPop('error', '필수 항목 및 입력 형식을 확인해주세요.')">저장</button>
							<router-link to="/mkup/lecture/bookMgt" class="btnM ml10">취소</router-link>
						</span>
					</div>
					<div class="tvs">
						<table>
	                  ...
	                  <span class="labelToggleSet">
	                    <input type="checkbox" id="siteView">
	                    <label for="siteView">
	                      <span>숨김</span>
	                      <span>노출</span>
	                    </label>
					...
					<div class="tvs">
						<table>
		                  ...
		                  <label for="chkTax"><i></i>소득공제</label>
									...
									<th>구매제한</th>
									<td>인당<span class="unit w100 ml10"><input type="number"><em>권</em></span></td>
								</tr>
								<tr>
	                      ...
	                      <option value="no" class="label">선택</option>
								...
								<tr>
									...
									<td colspan="3"><p class="infoMsg fGreen">* 교재 등록 후 구매권한을 설정해주세요</p></td>
								</tr>
							</tbody>
						</table>
					</div>
