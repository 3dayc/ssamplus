<template lang="html">
	<div>
					...
					<div class="bdLine">
						<span class="lsItem">
							<span class="selectSet lCase">
								<select name="" id="">
									<option value="no" class="label">배송처</option>
						...
						<span class="lsItem">
							<input type="text" placeholder="주문번호, 학습기기명 검색" />
          ...
          <col width="140"/>
				...
				<tbody>
					<tr>
						...
						<td class="tL"><em class="iSet green">학습기기</em><br/>갤럭시 탭A 10.1</td>
						<td class="tR">25,000</td>
						<td>KT상암센터</td>
						<td>배송 준비중</td>
						<td><a>125-783-19283</a></td>
						<td rowspan="3"><button class="btnS line" @click="PaymentOrderOnline()">메모</button></td>
					</tr>
					<tr>
						<td class="tL"><em class="iSet green">학습기기</em><br/>LG gram</td>
						<td class="tR">25,000</td>
						<td>KT상암센터</td>
						<td>배송 준비중</td>
						<td>
							<button class="btnS line" @click="PaymentOrderOnline()">주문 다운로드</button>
							<button class="btnS line ml10" @click="alertTrigger = true">번호 입력</button>
						</td>
					</tr>
					<tr>
					...
					<tr class="expiry">
						...
						<td><strong>홍길동 : 348178</strong><br/>(leeminji3030)</td>
						<td class="tL"><em class="iSet green">학습기기</em><br/>갤럭시 S21 울트라</td>
						<td class="tR">35,000</td>
						<td>이데아관</td>
					...
					<tr class="red">
						<td class="tL">2021-02-05(금) 22:32:48<br/><a @click="PaymentOrderDirect()">H-20210225-0000</a></td>
						<td><strong>홍길동 : 348178</strong><br/>(leeminji3030)</td>
						<td class="tL"><em class="iSet green">학습기기</em><br/>애플 아이패드</td>
        ...
        <button class="btnM green" @click="alertTrigger = false">입력</button>
			</template>
		</Alert>
		<!-- //번호입력 팝업 -->
		<!-- 다운로드 마스터 팝업 -->
