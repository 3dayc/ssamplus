<template lang="html">
  <div>
    <div class="content">
      <article>
        <!-- page layout -->
        <div class="singleCourseViewAttend">
          <!-- 검색 -->
                ...
                <div class="bdLine">
                  <span class="lsItem">
                    <span class="selectSet lCase">
                      <select name="" id="">
                        <option value="no" class="label">직강일</option>
                      </select>
                    </span>
                  </span>
                  <span class="lsItem">
                    <span class="selectSet lCase">
                      <select name="" id="">
                        <option value="no" class="label">출석 구분</option>
          ...
          <div class="listSummery">
            ...
            <div class="right">
              <button class="btnT line" @click="LectureAttendStatistics();">날짜별 출석통계</button>
              <button class="btnT line ml10" @click="alertTrigger2 = true">보충강의 제공</button>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr style="display:none;">
                  <td colspan="5" class="noneData">등록된 데이터가 없습니다.</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <!-- //데이터 없을 때-->
          <!-- 라이브 채팅 -->
          <div class="subTit mt10"><h3>라이브 채팅</h3></div>
          <div class="tls wHalf">
            <table>
              <colgroup>
                <col width="120"/>
              ...
              <tbody>
                <tr>
                  ...
                  <td>2021-01-16</td>
                  <td><button class="btnS line" @click="LectureLiveChat();">채팅 보기</button></td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div class="tls wHalf mt10">
            <table>
              ...
              <tbody>
                 <tr>
                  <td colspan="3" class="noneData">등록된 데이터가 없습니다.</td>
                </tr>
              </tbody>
            </table>
          </div>
...
export default {
  mixins: [Mixin],
  name: 'SingleCourseViewAttendLive',
  data() {
    return {
  ...
  methods: {
    MemberPartnerMsgSend() {
      let routeData = this.$router.resolve({name: 'MemberPartnerMsgSend', query: {data: "someData"}});
      window.open('/mkup/windowPopup/mmrPartnerMsgSend', '_blank', `width=850,height=20000`);
    },
    LectureAttendStatistics() {
      let routeData = this.$router.resolve({name: 'LectureAttendStatistics', query: {data: "someData"}});
      window.open('/mkup/windowPopup/lceAttendStatistics', '_blank', `width=570,height=750`);
    },
    LectureLiveChat() {
      let routeData = this.$router.resolve({name: 'LectureLiveChat', query: {data: "someData"}});
      window.open('/mkup/windowPopup/lceLiveChat', '_blank', `width=570,height=750`);
    },
    onChange(event) {
