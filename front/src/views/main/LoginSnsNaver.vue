	  		...
	  		<div class="whiteBox">
	    		<div class="snsLoginSetting">
	    			...
	    			<div class="soloUsing" v-if="snsOk">
							<p>
								<strong>네이버 인증이 완료되었습니다.</strong>
								<span>약관동의 후, 쌤플러스 아이디로 로그인하세요.<br/>다음부터는 <em>네이버 간편인증</em>을 통해 로그인이 가능해집니다.</span>
							</p>
	  					<div class="basicIp">
	            ...
	            <router-link to="./login" class="btnL line">취소</router-link>
	    			...
	    			<div class="otherUsing" v-if="snsGo">
							<p>
								입력하신 정보는 이미 <strong>카카오 간편 로그인 회원</strong>으로 <i>가입되어 있습니다.</i>
								<span>기존 아이디 : <em>don***</em></span>
							</p>
							<router-link to="/mkup/main" class="btnSns kakao"><em>계속 카카오로 간편 로그인</em></router-link>
	            <div>
