(function(){
    ...
    function createOriginalMediaPlayer(id, source, param, callback){
        ...
        if(!D.b.isMobile){
            ...
            rateInfo = [
                { 'value': 0.4, 'context': "0.4 배속", 'cvalue': "0.4 x" },
                { 'value': 0.6, 'context': "0.6 배속", 'cvalue': "0.6 x" },
                { 'value': 0.8, 'context': "0.8 배속", 'cvalue': "0.8 x" },
                { 'value': 1,   'context': "1.0 배속", 'cvalue': "1.0 x" },
                { 'value': 1.2, 'context': "1.2 배속", 'cvalue': "1.2 x" },
                { 'value': 1.4, 'context': "1.4 배속", 'cvalue': "1.4 x" },
                { 'value': 1.6, 'context': "1.6 배속", 'cvalue': "1.6 x" },
                { 'value': 1.8, 'context': "1.8 배속", 'cvalue': "1.8 X" },
                { 'value': 2,   'context': "2.0 배속", 'cvalue': "2.0 x" }
            ];
        }
        ...
        var attr = {
            ...
            module: {
                ...
                rate: {
                    ...
                    use: true,
                    useType: 'button', // button(mpv-rate-type-button) or list(mpv-rate-type-list). 버튼 타입이 아니면 리스트 타입 입니다.
    ...
    function getHtmlResource(param){
        ...
        h.push("        <button class='mpv-previous-skip-btn mpv-button mpv-bctrl-btn' title='뒤로 스킵 버튼'></button>\n");
